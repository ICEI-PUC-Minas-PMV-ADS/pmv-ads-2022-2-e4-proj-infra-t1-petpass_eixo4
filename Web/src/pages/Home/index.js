    ...
    <div className="home-container">
      <div className="base-card home-card">
        <div className="home-content-container">
          ...
          <div className="button-home-card">
            <Link to="/auth">
